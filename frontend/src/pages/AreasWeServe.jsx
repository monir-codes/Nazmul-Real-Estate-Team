...
const AreasWeServe = () => {
  return (
    <div className="pt-24 min-h-screen">
      <SEO 
        title="Areas We Serve | Top Real Estate Agent in Your City"
        description="Explore the neighborhoods we serve. Get expert insights into local markets, schools, and lifestyle to find your perfect home."
      />
      {/* Hero */}
      <div className="bg-primary text-white py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1580659328221-a53ec8651817?w=1600&q=80')] bg-cover bg-center opacity-40" />
